...
$results = $analytics->data_ga->get(
  ...
  $fromDate,
  $toDate,
 'ga:sessions,ga:percentNewSessions,ga:newUsers,ga:bounceRate,ga:pageviewsPerSession,ga:avgSessionDuration,ga:goalConversionRateAll,ga:goalCompletionsAll,ga:goalValueAll',
  array(
    'dimensions'  => 'ga:channelGrouping,ga:fullReferrer',
    'sort'        => '-ga:sessions',
    'max-results' => 3000
  ) );
