...
$results = $analytics->data_ga->get(
  ...
  $fromDate,
  $toDate,
  'ga:impressions,ga:adClicks,ga:adCost,ga:CTR,ga:CPM,ga:CPC,ga:goalCompletionsAll,ga:goalConversionRateAll',
  array(
    'dimensions'  => 'ga:date',
    'sort'        => 'ga:date'
    //'max-results' => 30
...
foreach( $rows as $row ) {
  $data[] = array(
    ...
    'adcpm' => $row[5],
    'adcpc' => $row[6],
    'adgoalcompletions' => $row[7],
    'adgoalconversionrate' => $row[8]
  );
}
