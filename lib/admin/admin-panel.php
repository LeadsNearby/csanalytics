...
<link rel="stylesheet" href="//cdn.datatables.net/1.10.16/css/jquery.dataTables.min.css">
	...
	var NewConvData = '<?php echo site_url() . '/wp-content/plugins/csanalytics/lib/data/data-ConvirzaData.php' ?>';
...
//-------- End NEW ADWORDS DATA COLLECTOIN
		...
		jQuery.when(
			...
			jQuery.each(data2[0].data, function(i, value) {
				TotalCount = data2[0].data.length;
				TotalCallMinutes += parseFloat(data2[0].data[i].duration);
				var phoneNumbers = data2[0].data[i].caller_id;
				if ( !phoneNumbers.match(/^(\+?1)?(8(00|44|55|66|77|88)[2-9]\d{6})$/) && data2[0].data[i].duration > 90 && data2[0].data[i].disposition === "ANSWERED") {
					ValueCalls+++1
					if(TotalCallMinutes > 60000) {
						ValueCallMinutes += Math.floor(parseFloat(data2[0].data[i].duration) / 60);
					}
					else {
						ValueCallMinutes += Math.floor(parseFloat(data2[0].data[i].duration) / 60);
				...
				TotalCallMin += parseFloat(data2[0].data[i].duration) / 60;
				AvgCallDuration = TotalCallMin / TotalCount;
				chatHTML += '<tr><td class="tg-yw4l">' + data2[0].data[i].call_created + '</td><td class="tg-yw4l">' + data2[0].data[i].tracking_number + '</td><td class="tg-yw4l">' + data2[0].data[i].disposition + '</td><td class="tg-yw4l">' + data2[0].data[i].duration + '</td><td class="tg-yw4l">' + data2[0].data[i].call_id + '</td><td class="tg-yw4l">' + data2[0].data[i].is_outbound + '</td><td class="tg-yw4l">' + data2[0].data[i].campaign_id + '</td><td class="tg-yw4l">' + data2[0].data[i].repeat_call + '</td><td class="tg-yw4l">' + data2[0].data[i].caller_id + '</td><td class="tg-yw4l">' + data2[0].data[i].ring_to + '</td><td class="tg-yw4l"><audio src="' + data2[0].data[i].recordURL + '" controls></audio></td></tr>';
			});
